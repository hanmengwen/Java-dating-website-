        ...
        try {
            ...
            while(fileItems.hasNext())
            {
                ...
                //  }
                    ...
                    //????????????????????
                    String a="D:"+"\\"+"project"+"\\"+"hunlianjiaoyou"+"\\"+"WebContent"+"\\"+"image";
                    File file = new File(a,newFileName);
                  //  D:\project\hunlianjiaoyou\WebContent\image
                    //File file = new File(req.getServletContext().getRealPath("/image"),newFileName);
